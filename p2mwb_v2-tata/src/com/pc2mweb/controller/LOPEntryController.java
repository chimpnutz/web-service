...
@Controller
@RequestMapping("entrylop")
public class LOPEntryController {
	...
	public ModelAndView payCredit(@RequestParam("poid") int id,HttpServletRequest request,HttpSession session) throws NamingException {
		...
		ModelAndView modelAndView = new ModelAndView("entrylop");
		...
		if (null == isSession.getAttribute("USER")) {	
				...
				List<PurchaseOrderModel> poList3 = dao.getPOItemsDetails2(isSession, id);
				
				modelAndView.addObject("polist3", poList3);
