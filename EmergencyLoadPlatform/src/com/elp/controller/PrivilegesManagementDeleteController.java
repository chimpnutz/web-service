...
@Controller
@RequestMapping("privilegesmanagement-delete")
public class PrivilegesManagementDeleteController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(PrivilegesManagementDeleteController.class);	
