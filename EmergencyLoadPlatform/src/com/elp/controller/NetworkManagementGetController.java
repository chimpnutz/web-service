...
@Controller
@RequestMapping("networkmanagement-get")
public class NetworkManagementGetController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(NetworkManagementGetController.class);
	
	
	@RequestMapping(method = RequestMethod.POST)
    public @ResponseBody List <NetworkManagementModel> getcompany(@RequestParam("level") String level, HttpSession session)
    {
