...
public class CommentRequestController {
	...
	public @ResponseBody  String saveComment(
		...
		int isSaved = commentDAOImpl.save(comment);
	...
	public @ResponseBody  Collection selectAllComment() throws SQLException{
		Collection s = commentDAOImpl.selectJoinComments();
