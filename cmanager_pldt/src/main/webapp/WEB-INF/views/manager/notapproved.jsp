...
<div class="boxes"> </div>
	...
	<div class="linespace">
		...
		<div class="spacer"></div>
			...
			<ul class="cssmenu2">
	<li class="allapp"><a href="recent" title="allapp"><span class="displace2">AllApp</span></a></li>
	...
	<li class="notapproved"><a href="notapproved"  class="selected2" title="notapproved"><span class="displace2">not approved</span></a></li>
