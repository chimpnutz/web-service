        ...
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="adduser.html">New user form</a></li>
        ...
        <div id="pad-wrapper">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row ctrls">
                        <!-- Split button -->
                        <div class="btn-group">
                        <a href="philhealth-home.html">    <button type="button" class="btn btn-default ">Recent</button></a>
                        </div>


                        <div class="btn-group">
                        <a><button type="button" class="btn btn-default active">Return</button></a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-title="Name of Applicant">
                                    ...
                                    <a style="text-decoration:none; color:#747474" href="philhealth-application.html">Tata Madlang Tuta</a>
                                </td>
                                <td data-title="Application Id">
                                 <a style="text-decoration:none; color:#747474" href="philhealth-application.html">  534534635223423</a>
                                </td>
                                <td data-title="Receipt Number">
                                 <a style="text-decoration:none; color:#747474" href="philhealth-application.html">  12345</a>
                                </td>
                                <td data-title="Status">
                                 <a style="text-decoration:none; color:#747474" href="philhealth-application.html"><span class="label label-danger">Declined</span></a>
                                   
                                </td>


                                <td data-title="Date">
                                  <a style="text-decoration:none; color:#747474" href="philhealth-application.html"> April 1, 2014</a>
                                </td>
