...
@Controller
@RequestMapping("usermanagement-delete")
public class UserManagementDeleteController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(UserManagementDeleteController.class);	
	
	@RequestMapping(method = RequestMethod.POST)
    public @ResponseBody String adduser(@RequestParam("userid") int userid, HttpSession usersession)
    {
