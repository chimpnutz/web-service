                     ...
                     <thead>
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${details}" var="data">
								<c:if test="${data.type == 'philhealth'}">
									<c:if test="${data.role == '6'}">
			                            <tr>
			                                <td data-title="Name of Applicant">
			                                  
			                                   
			                                    <a href="philhealth-application.html?userid=${data.id}" style="text-decoration:none; color:#747474" >${data.firstName} ${data.lastName}</a>
			                                </td>
			                                <td data-title="Application Id">
			                                 <a  href="philhealth-application.html?userid=${data.id}" style="text-decoration:none; color:#747474">  PagIbig</a>
			                                </td>
			                                
			                               <!-- <td data-title="Date">
			                                  <a href="philhealth-application.html?userid=${data.id}" style="text-decoration:none; color:#747474" > 
			                                  </a>
			                                </td>
			                                <td data-title="Status">
			                                 <a href="philhealth-application.html?userid=${data.id}" style="text-decoration:none; color:#747474" ><span class="label label-success">Approved</span></a>                                   
			                                </td> 
			                                
			                                <td data-title="Receipt Number">
			                                 <a href="philhealth-application.html?userid=${data.id}" style="text-decoration:none; color:#747474" >  12345</a>
			                                </td> -->
