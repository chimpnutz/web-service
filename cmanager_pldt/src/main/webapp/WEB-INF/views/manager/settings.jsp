		...
		<div class="header clearfix">
			...
			<div class="nav">
				...
				<ul class="menu">
					...
					<li><a href="settings" class="selected"><i class="fa fa-mobile-phone"></i>&nbsp;MOBILE</a></li>	
...
<c:if test="${role=='manager' }">
<form action="savePhoneSetting"  method="POST" ENCTYPE="multipart/form-data" class="box login">
    ...
    <tr >
      <td width="300">
        <font face="Lucida Grande" size="2" color="#666666"><b>Phone Model</b></font> <span style="color:red;"><small>*</small></span>
      </td>
      <td colspan="2" style="">
        <input value="" size="52" name="phone_model" type="text" />${message1 }
        <div style="padding-bottom:8px;color:#666666;"></div>
      </td>
    </tr>
    <tr >
      <td align="left">
        <font face="Lucida Grande" size="2" color="#666666"><b>Phone Code</b></font> <span style="color:red;"><small>*</small></span>
      </td>
      <td colspan="2" id="td_element_field_1" style="">
        <input value="" size="52" name="phone_code" type="text" />${message2 }
        <div style="padding-bottom:8px;color:#666666;"></div>
      </td>
    </tr>
    ...
    <tr >
      <td align="left">
        <font face="Lucida Grande" size="2" color="#666666"><b>Phone Manufacturer</b></font> <span style="color:red;"><small>*</small></span>
      </td>
      <td colspan="2" id="td_element_field_1" style="">
        <input  value="" size="52" name="phone_mfr" type="text" />${message3 }
        <div style="padding-bottom:8px;color:#666666;"></div>
      </td>
    </tr>
    ...
    <tr>
      <td align="left">
        <font face="Lucida Grande" size="2" color="#666666"><b>Phone Image</b></font> <span style="color:red;"><small>*</small></span>
      </td>
      <td colspan="2" id="td_element_field_1" style="">
       <tr>
<td><label for="file1">File</label></td>
<td><input name="phone_image" type="file" id="file"/></td>
</tr>
   </td>

	<tr valign="top">
			<td><font face="Lucida Grande" size="3" color="#666666">Availability :</font></td>
			<td>
...
<tr valign="top">
      ...
      <td colspan="2">
        <textarea  name="phone_desc"   cols="70" rows="10">
</textarea>${message5 }
        <div style="padding-bottom:8px;color:#666666;"></div>
      </td>
    </tr>
