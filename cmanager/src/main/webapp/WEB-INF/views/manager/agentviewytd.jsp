           ...
           <div>
            ...
            <input type="button" class="ok" value="Send" />
             <input type="button" class="cancel"  value="Cancel" />
				...
				<li class="mtd"><a href="agentmtd.html" title="month to date"><span class="displace2">mtd</span></a></li>
				<li class="monthly"><a href="agentmonthly.html" title="year to date"><span class="displace2">monthly</span></a></li>
	
				<li class="ytd"><a href="agentviewytd.html"  class="selected2"  title="year to date"><span class="displace2">ytd</span></a></li>
