...
<p style="margin:20px auto;"><span class="bigtext_red_bold">Good News</span><span class="text">: In case your wallet has been depleted during non-working holidays and weekend. You can now avail our emergency load that has to be paid immediately on the next working day.<br />
</span></p>

<form:form action=""  commandName="emergencyForm" id="emergencyForm">
	...
	<table width="70%" border="0" cellspacing="3" cellpadding="3">   
		...
		<tr>
			<td>&nbsp;</td>
			 <td><input type="image" value="Submit" src="../css/images/submit2_button.png" style="margin-left:150px;"/></td>
		</tr>
