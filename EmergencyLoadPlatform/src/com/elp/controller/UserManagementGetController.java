...
@Controller
@RequestMapping("usermanagement-get")
public class UserManagementGetController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(UserManagementGetController.class);	
	

	@RequestMapping(method = RequestMethod.POST)
    public @ResponseBody List <UserManagementModel> getRetailer(@RequestParam("cid") String cid, HttpSession session)
    {
