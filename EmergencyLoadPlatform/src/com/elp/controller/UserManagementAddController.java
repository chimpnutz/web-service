...
@Controller
@RequestMapping("usermanagement-add")
public class UserManagementAddController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(UserManagementAddController.class);	
	...
	@RequestMapping(method = RequestMethod.GET,params={"success"})
	 public ModelAndView successView(HttpServletRequest request,HttpSession session) throws NamingException {
	...
	public ModelAndView addUser(@ModelAttribute("usermanagementForm") UserManagementModel model,  
            BindingResult result,HttpSession session,HttpServletRequest request) 
	{
		...
		ModelAndView page = new ModelAndView("redirect:usermanagement-add.html");
		...
		if(dao.addnewUser(session, model)){
