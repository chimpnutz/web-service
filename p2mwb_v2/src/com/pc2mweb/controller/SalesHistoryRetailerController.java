...
@Controller
@RequestMapping("saleshistory-retailer")
public class SalesHistoryRetailerController {
	
	private static final Logger logger = Logger.getLogger(SalesHistoryRetailerController.class);
	...
	@RequestMapping(method = RequestMethod.GET)
 	 public ModelAndView login(ModelMap model,HttpServletRequest request,HttpSession usersession) throws ParseException {
		...
		ModelAndView modelAndView = new ModelAndView("saleshistory-retailer");
