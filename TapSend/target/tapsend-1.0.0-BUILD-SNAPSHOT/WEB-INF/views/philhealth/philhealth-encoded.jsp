...
<body>
    ...
    <header class="navbar navbar-inverse" role="banner">
        <div class="navbar-header">
            ...
            <a class="navbar-brand  hidden-xs" href="philhealth-home" style="padding:0px 20px !important;margin-top:15px;">
               <p>Phil Health</p>
            </a>
        </div>
        <!--hidden-xs-->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="Status">
                                 <a style="text-decoration:none; color:#747474" href="philhealth-application.html"><span class="label label-success">Approved</span></a>
