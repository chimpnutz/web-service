...
<html><head><style id="flot-default-styles">.flot-tick-label {font-size:smaller;color:#545454;}</style>
	...
	<script type="text/javascript" src="resources/admin/js/sortable.js"></script>
    <!--[if lt IE 9]>
 ...
 <li>
    ...
    <div class="content">
        ...
        <div id="pad-wrapper">
            ...
            <table class="table col-md-12 table-hover table-striped table-condensed sortable" id="anyid">
                     ...
                     <thead>
                        ...
                        <tbody>
                        <c:forEach items="${parent}" var="data">            

                                
									<c:if test="${data.role == '6' && data.type != '4'}">
                            ...
                            <tr>
                              ...
                              <td data-title="Status">
                                ...
                                <c:otherwise>
                                <td data-title="Status">
                                 <a href="superadmin-application-member.html?userid=${data.id }" style="text-decoration:none; color:#747474" >None</a>                                  
                                </td>
                                </c:otherwise>
                               </c:choose>
                              ...
                              <td data-title="Status">
                                 <a href="superadmin-application-member.html?userid=${data.id }" style="text-decoration:none; color:#747474" >Business Employer</a>                                  
                                </td> 
                                </c:if>
                                ...
                                <c:if test="${data.type == '3'}">
	                                ...
	                                <td data-title="Status">
	                                 <a href="superadmin-application-member.html?userid=${data.id }" style="text-decoration:none; color:#747474" >Employee - ${data.bfirstname} ${data.blastname }</a>                                  
	                                </td> 
                              ...
                              <td data-title="Status">
                                 <a href="superadmin-application-member.html?userid=${data.id }" style="text-decoration:none; color:#747474" >Household Employer</a>                                  
                                </td> 
                                </c:if>
