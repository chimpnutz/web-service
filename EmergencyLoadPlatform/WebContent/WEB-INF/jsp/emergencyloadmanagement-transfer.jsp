...
<div id="container"><!-----Start of Container ----->
 ...
 <core:if test="${roleid == 1 || roleid == 2 || roleid == 3 || roleid == 4 || roleid ==5 || roleid == 8}">
	...
	<input type="hidden" value="${data.companyname}" id="hdnCompname" class="hdnCompname">
    ...
    <input type = "hidden" id="hdnOldstatus" class="hdnOldstatus" value="${data.transfer_status}">
	  <table width="700" border="0" align="center" cellpadding="3" cellspacing="0">
	    ...
	    <tr>
	      <td class="text12_tungsten_bold">Transfer Status</td>
	    ...
	    <tr>
	      ...
	      <td><input type="image" src="../css/images/submit.png" id="btnTransfer" class="btnTransfer"></td>
        </tr>
      </table>
      </core:forEach>
	</div>
