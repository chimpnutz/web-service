		...
		<div class="header clearfix">
			...
			<div class="nav">
				...
				<ul class="menu">
					...
					<li><a href="index"><i class="fa fa-laptop"></i>&nbsp;Log out</a></li>
...
<script>
		...
		var barChartData = {
			...
			datasets : [
				...
				},
				{
					...
					data : [42.4, 53.2, 34.5, 59.7, 52.6, 35.5, 57.4, 60.4, 47.6, 60.1, 86.8]
				}
			]
	...
	var myLine = new Chart(document.getElementById("canvas").getContext("2d")).Bar(barChartData);
					...
					<div id="dd" class="wrapper-dropdown-2" tabindex="1">Year To Date
						<ul class="dropdown">
