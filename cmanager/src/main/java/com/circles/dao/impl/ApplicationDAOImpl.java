...
public class ApplicationDAOImpl {
	...
	public int update(Application application){
		...
		try{
			if(!application.getPhone_code().isEmpty()||!application.getPhone_code().equals(null)||!application.getPhone_code().equals("")){
				sql+=", phone_code=?";
				iterator++;
			}
		}catch(NullPointerException e){
		...
		try{
			if(!application.getPhone_code().isEmpty()||!application.getPhone_code().equals(null)||!application.getPhone_code().equals("")){
				params[iterator] = application.getPhone_code();
				iterator++;
			}
		}catch(NullPointerException e){
...
/*	@SuppressWarnings("rawtypes")
	private static final class ApplicationMapper implements RowMapper<Application> {
	    ...
	    public Application mapRow(ResultSet rs, int rowNum) throws SQLException {
	        ...
	        application.setPhone_code(rs.getString("phone_code"));
