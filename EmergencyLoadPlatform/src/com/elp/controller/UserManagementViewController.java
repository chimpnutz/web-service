...
@Controller
@RequestMapping("usermanagement-view")
public class UserManagementViewController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(UserManagementViewController.class);
    ...
    public ModelAndView view(@RequestParam("userid") int userid, HttpServletRequest request,HttpSession session) 
	{
		...
		ModelAndView page = new ModelAndView("usermanagement-view");
