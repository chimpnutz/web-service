...
@Controller
@RequestMapping("holidaymanagement-delete")
public class HolidayManagementDeleteController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(HolidayManagementDeleteController.class);	
