...
public class HolidayManagementController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(HolidayManagementController.class);
	...
	@RequestMapping(method = RequestMethod.GET)
	 public ModelAndView topupView(HttpServletRequest request,HttpSession session) throws NamingException {
		...
		ModelAndView page = new ModelAndView("holidaymanagement");
		...
		if (null == isSession.getAttribute("username")) {		
				...
				return loginpage;	
				 ...
				 {		
					...
					List<HolidayModel> holiday = dao.getHolidays();
					

					page.addObject("holidaylist",holiday);
