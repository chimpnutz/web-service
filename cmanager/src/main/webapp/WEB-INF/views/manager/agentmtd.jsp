			...
			datasets : [
				{
					...
					data : [49.9, 71.5, 106.4, 29.2, 44.0, 176.0, 135.6, 48.5, 16.4, 24.1, 95.6, 54.4 , 54.4 , 54.4]
				},
			]
            ...
            <input type="button" class="ok" value="Send" />
             <input type="button" class="cancel"  value="Cancel" />
				...
				<li class="recent"><a href="agentrecent.html"><span class="displace2">recent</span></a></li>
					...
					<li class="mtd"><a href="agentmtd.html"  class="selected2"  title="month to date"><span class="displace2">mtd</span></a></li>
