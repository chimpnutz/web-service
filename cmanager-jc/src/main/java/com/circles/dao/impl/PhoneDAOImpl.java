...
public class PhoneDAOImpl {
	...
	public Collection getPhone(Phone phone,String id){
		return jdbcTemplate.query("SELECT a.* FROM phone a INNER JOIN application b ON a.phone_id = b.phone_id WHERE b.application_id = ?",new Object[] {id},new PhoneMapper());
	}
