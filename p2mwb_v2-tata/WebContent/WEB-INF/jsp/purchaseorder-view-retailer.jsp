...
<core:forEach var="data2" items="${list }">
<core:if test="${ data2.item != 'LOP'}">
	...
	<core:forEach var="data" items="${list }">
		<core:if test="${data.payment_status != 'paid' }">
			...
			<core:if test="${user != 'superadmin'}">
			    ...
			    <core:if test ="${data.payment_status != 'for verification' && data.payment_status != 'paid' && data.po_status != 'cancelled' && data.item !='LOP'}">	
		...
		<core:if test="${data.po_status == 'active' && data.payment_status != 'paid' }">
			...
			<core:if test="${user != 'superadmin'}">
			   ...
			   <core:forEach var="datas" items="${pomlist }">
				...
				<core:if test="${data.payment_status  == 'for verification' && datas.status != 'cancelled' && data.item != 'LOP'}">	
...
<form:form action="" commandName="paymentorderForm2" id="paymentorderForm2" enctype="multipart/form-data">
