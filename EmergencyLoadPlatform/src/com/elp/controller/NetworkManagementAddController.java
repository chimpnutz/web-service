...
@Controller
@RequestMapping("networkmanagement-add")
public class NetworkManagementAddController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(NetworkManagementAddController.class);
	...
	@RequestMapping(method = RequestMethod.GET)
	 public ModelAndView topupView(HttpServletRequest request,HttpSession session) throws NamingException {
		...
		ModelAndView page = new ModelAndView("networkmanagement-add");
		...
		if (null == isSession.getAttribute("username")) {		
				 ...
				 {		
					...
					Map levellist = dao.getLevellist(session);
					...
					page.addObject("levellist",levellist);
	...
	public ModelAndView addcompany(@ModelAttribute("networkmanagementForm") NetworkManagementModel model,  
            BindingResult result,HttpSession session,HttpServletRequest request) 
	{
		...
		if(dao.addCompany(session, model)){
