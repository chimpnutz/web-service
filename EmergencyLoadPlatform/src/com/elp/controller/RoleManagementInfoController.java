...
@Controller
@RequestMapping("rolemanagement-info")
public class RoleManagementInfoController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(RoleManagementInfoController.class);

	
	
	@RequestMapping(method = {RequestMethod.GET},params={"roleid"})
    public ModelAndView viewroles(@RequestParam("roleid") int roleid, HttpServletRequest request,HttpSession session) 
	{
		...
		ModelAndView page = new ModelAndView("rolemanagement-info");
