...
@Controller
@RequestMapping("creditlimitmanagement-get")
public class CreditLimitManagementGetController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(CreditLimitManagementGetController.class);
	
	
	
	@RequestMapping(method = RequestMethod.POST)
    public @ResponseBody List <CreditLimitManagementModel> getRetailer(@RequestParam("dsp") String dsp, HttpSession session)
    {
