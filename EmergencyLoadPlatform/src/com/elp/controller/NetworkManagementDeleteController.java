...
@Controller
@RequestMapping("networkmanagement-delete")
public class NetworkManagementDeleteController implements ServletContextAware{
	
	@Autowired
	private ServletContext servletContext;
	private static final Logger logger = Logger.getLogger(NetworkManagementDeleteController.class);	
