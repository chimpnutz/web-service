...
public class MailModel
{
	...
	public void sendMail(final Application user,final String from) {
...
public class MailModel implements ServletContextAware{ 
	...
	public void sendMail(final UserDetails userDetails, final HttpServletRequest request, 
			final String date) {
        MimeMessagePreparator preparator = new MimeMessagePreparator() {
			...
			public void prepare(MimeMessage mimeMessage) throws Exception {
               ...
               is = String.format("%s://%s:%d/TapSend",request.getScheme(),  request.getServerName(), request.getServerPort());
